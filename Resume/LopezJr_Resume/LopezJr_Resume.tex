...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Martin}{Martin Lopez Jr.}
%\address{Milpitas, CA}
%\mobile{(631) 456-7730} 
%%% Social
\email{martinlopezjr28@outlook.com}
\homepage{www.mjlopezjr.com}
\github{martinlopezjr28}
\linkedin{martin-lopez-jr}
%%% Optionals
...
%\vspace{-0.2cm}
\import{\sectiondir}{technical_experience.tex}
%\vspace{-0.2cm}
\import{\sectiondir}{publications.tex}
%\vspace{-0.2cm}
\import{\sectiondir}{computation.tex}
%\vspace{-0.2cm}
